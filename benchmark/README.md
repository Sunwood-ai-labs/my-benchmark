...
- 実際の依頼文に近い `public/problem.md`
- 最低限の `public/context.md`
- 受け入れ済みの正をまとめた `private/answer.md`
- hidden evaluator 面の `private/rubric.md`
...
3. evaluator は `private/answer.md` と `private/rubric.md` を使う
