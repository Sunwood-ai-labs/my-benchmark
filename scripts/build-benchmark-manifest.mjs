...
for (const { split, dir } of splits) {
  ...
  for (const caseDir of caseDirs) {
    ...
    manifestEntries.push({
      ...
      public_prompt: path.relative(repoRoot, path.join(caseRoot, "public", "problem.md")).replaceAll("\\", "/"),
      public_context: path.relative(repoRoot, path.join(caseRoot, "public", "context.md")).replaceAll("\\", "/"),
      private_answer: path.relative(repoRoot, path.join(caseRoot, "private", "answer.md")).replaceAll("\\", "/"),
      private_rubric: path.relative(repoRoot, path.join(caseRoot, "private", "rubric.md")).replaceAll("\\", "/"),
